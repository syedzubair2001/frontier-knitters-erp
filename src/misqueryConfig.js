    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          { key: 'logistics-despatch-statement', label: 'DESPATCH STATEMENT', icon: '🚚', route: '/misquery/logistics-despatch-statement' },
{ key: 'logistics-commission-register', label: 'COMMISSION REGISTER', icon: '💹', route: '/misquery/logistics-commission-register' },
          { key: 'logistics-inv-profit-statement', label: 'INV/PROFIT STATEMENT', icon: '📈', route: '/misquery/logistics-inv-profit-statement' },
        ],
      },
    ],
  },
...
// Dummy data for the Despatch Statement table (Misquery > Logistics > Despatch Statement)
export const INITIAL_DESPATCH_STATEMENT = [
  {
    id: 'dspst-1',
    sNo: '1',
    despatchNo: 'DSP-2026-101',
    invoiceNo: 'EXP-INV-2026-101',
    orderNo: 'ORD-2026-4601',
    refNo: 'REF-3101',
    company: 'FRONTIER KNITTERS (P) LTD',
    customer: 'Nike Global',
    country: 'USA',
  ...
  },
  {
    id: 'dspst-4',
    sNo: '4',
    despatchNo: 'DSP-2026-104',
    invoiceNo: 'EXP-INV-2026-104',
    orderNo: 'ORD-2026-4604',
    refNo: 'REF-3104',
    company: 'FRONTIER PRINTING',
    customer: 'H&M',
    country: 'China',
  ...
  },
  {
    id: 'dspst-5',
    sNo: '5',
    despatchNo: 'DSP-2026-105',
    invoiceNo: 'EXP-INV-2026-105',
    orderNo: 'ORD-2026-4605',
    refNo: 'REF-3105',
    company: 'FRONTIER FASHIONS',
    customer: 'Zara',
    country: 'India',
  ...
  },
  {
    id: 'dspst-6',
    sNo: '6',
    despatchNo: 'DSP-2026-106',
    invoiceNo: 'EXP-INV-2026-106',
    orderNo: 'ORD-2026-4606',
    refNo: 'REF-3106',
    company: 'FRONTIER KNITTERS (P) LTD',
    customer: 'Nike Global',
    country: 'UAE',
    companyUnit: 'Unit 1',
    supplier: 'Global Tex Equipment Spares',
    merchandiser: 'Ali Hassan',
    despatchDate: '2026-09-20',
    status: 'Active',
  },
...
// Dummy data for the Commission Register table (Misquery > Logistics > Commission Register)
export const INITIAL_COMMISSION_REGISTER = [
  {
    id: 'comreg-1',
    sNo: '1',
    invoiceNo: 'EXP-INV-2026-301',
  ...
  },
  {
    ...
    currency: 'INR',
    commissionPct: '1.5',
    commissionAmount: '45500.00',
    status: 'Closed',
  },
  {
    id: 'comreg-4',
    sNo: '4',
    invoiceNo: 'PRC-INV-2026-304',
    ...
    currency: 'USD',
    commissionPct: '3.0',
    commissionAmount: '76000.00',
    status: 'Valid',
  },
  {
    id: 'comreg-5',
    sNo: '5',
    invoiceNo: 'EXP-INV-2026-305',
  ...
  },
  {
    ...
    currency: 'USD',
    commissionPct: '1.75',
    commissionAmount: '88000.00',
    status: 'Active',
  },
];

// Dummy data for the Invoice Wise Profitability Statement table (Misquery > Logistics > Inv/Profit Statement)
export const INITIAL_INV_PROFIT_STATEMENT = [
  {
    id: 'invprof-1',
    sNo: '1',
    invoiceNo: 'EXP-INV-2026-401',
    invoiceDate: '2026-09-08',
    company: 'FRONTIER KNITTERS (P) LTD',
    buyer: 'Nike Global',
    orderNo: 'ORD-2026-4401',
    qty: '12500',
    invoiceValue: '875000.00',
    cost: '690000.00',
    profit: '185000.00',
    profitPct: '21.14',
    status: 'Active',
  },
  {
    id: 'invprof-2',
    sNo: '2',
    invoiceNo: 'EXP-INV-2026-402',
    invoiceDate: '2026-09-11',
    company: 'FRONTIER FASHIONS',
    buyer: 'Adidas',
    orderNo: 'ORD-2026-4402',
    qty: '8200',
    invoiceValue: '512500.00',
    cost: '418000.00',
    profit: '94500.00',
    profitPct: '18.44',
    status: 'Active',
  },
  {
    id: 'invprof-3',
    sNo: '3',
    invoiceNo: 'EXP-INV-2026-403',
    invoiceDate: '2026-09-13',
    company: 'FRONTIER KNITTERS (P) LTD',
    buyer: 'Puma',
    orderNo: 'ORD-2026-4403',
    qty: '6500',
    invoiceValue: '390000.00',
    cost: '331500.00',
    profit: '58500.00',
    profitPct: '15.00',
    status: 'Closed',
  },
  {
    id: 'invprof-4',
    sNo: '4',
    invoiceNo: 'EXP-INV-2026-404',
    invoiceDate: '2026-09-16',
    company: 'FRONTIER PRINTING',
    buyer: 'Adidas',
    orderNo: 'ORD-2026-4404',
    qty: '9800',
    invoiceValue: '623000.00',
    cost: '489000.00',
    profit: '134000.00',
    profitPct: '21.51',
    status: 'Valid',
  },
  {
    id: 'invprof-5',
    sNo: '5',
    invoiceNo: 'EXP-INV-2026-405',
    invoiceDate: '2026-09-18',
    company: 'FRONTIER FASHIONS',
    buyer: 'Puma',
    orderNo: 'ORD-2026-4405',
    qty: '5400',
    invoiceValue: '318600.00',
    cost: '296000.00',
    profit: '22600.00',
    profitPct: '7.09',
    status: 'Cancel',
  },
  {
    id: 'invprof-6',
    sNo: '6',
    invoiceNo: 'EXP-INV-2026-406',
    invoiceDate: '2026-09-21',
    company: 'FRONTIER KNITTERS (P) LTD',
    buyer: 'Nike Global',
    orderNo: 'ORD-2026-4406',
    qty: '11000',
    invoiceValue: '792000.00',
    cost: '618000.00',
    profit: '174000.00',
    profitPct: '21.97',
    status: 'Active',
