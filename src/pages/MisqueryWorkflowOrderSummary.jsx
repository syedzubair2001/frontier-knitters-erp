...
export default function MisqueryWorkflowOrderSummary() {
  ...
  const [subContractor, setSubContractor] = useState('--Select--');
  ...
  const handleClear = () => {
    ...
    setActiveSubContractor(false); setSubContractor('--Select--');
        ...
        {!submitted && (
          <form onSubmit={handleSubmit} style={{ backgroundColor: '#ffffff', borderRadius: 8, padding: '20px 24px', boxShadow: '0 1px 3px rgba(0,0,0,0.05)', border: '1px solid #e2e8f0', marginBottom: 24 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 16, marginBottom: 20 }}>
              ...
              <div style={{ padding: 12, backgroundColor: '#f8fafc', border: '1px solid #e2e8f0', borderRadius: 8, display: 'flex', flexDirection: 'column', gap: 12, gridColumn: 'span 2' }}>
                <label style={{ fontSize: 12, fontWeight: 700, color: '#64748b', textTransform: 'uppercase' }}>Shipment Date</label>
            ...
            {/* Row 5: Radios */}
            <div style={{ padding: 16, backgroundColor: '#f8fafc', border: '1px solid #e2e8f0', borderRadius: 8, marginBottom: 20, display: 'inline-block' }}>
            ...
            {/* Row 6: Additional Options & Actions */}
          ...
          <div>
            ...
            <div style={{ backgroundColor: '#ffffff', borderRadius: 8, boxShadow: '0 1px 3px rgba(0,0,0,0.05)', border: '1px solid #e2e8f0', overflow: 'hidden' }}>
              <div style={{ padding: '16px 20px', backgroundColor: '#f8fafc', borderBottom: '1px solid #e2e8f0', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <div>
                  <h3 style={{ margin: 0, fontSize: 16, fontWeight: 700, color: '#0f172a' }}>Process/Production : Value</h3>
                  {(displayFrom || displayTo) && (
                    <p style={{ margin: '4px 0 0', fontSize: 12, color: '#64748b', fontWeight: 600 }}>
                      Shipment Date: {displayFrom || '-'} to {displayTo || '-'}
                    </p>
                  )}
                </div>
                ...
                <table style={{ width: '100%', minWidth: 1000, borderCollapse: 'collapse', fontSize: 13 }}>
                  <thead>
                    <tr style={{ backgroundColor: '#f1f5f9', borderBottom: '1px solid #cbd5e1' }}>
                      ...
                      <th style={{ padding: '10px 12px', textAlign: 'left', fontWeight: 700 }}>Process Details</th>
                      <th style={{ padding: '10px 12px', textAlign: 'left', fontWeight: 700 }}>Unit / Contractor</th>
                      <th style={{ padding: '10px 12px', textAlign: 'left', fontWeight: 700 }}>Merchandiser / Manager</th>
                      <th style={{ padding: '10px 12px', textAlign: 'left', fontWeight: 700 }}>Status</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr><td colSpan={6} style={{ padding: 32, textAlign: 'center', color: '#64748b', fontStyle: 'italic' }}>Related Process/Production data will be displayed here.</td></tr>
                  </tbody>
                </table>
              </div>
            </div>
