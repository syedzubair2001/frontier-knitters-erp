...
export default function MisqueryWorkflowPendingOrders() {
  ...
  const handleClear = () => {
    ...
    setActiveCompanyUnit(false); setCompanyUnit('-- All --');
    ...
    setActiveProcess(false); setProcessType('-- All --');
    setOrderNo(''); setRefNo('');
    setStatus('All');
  ...
  const radioDropdownFields = [
    ...
    { label: 'Company Unit', active: activeCompanyUnit, setActive: setActiveCompanyUnit, value: companyUnit, setValue: setCompanyUnit, list: ['-- All --'].concat(UNIT_SUPPLIER_LIST.slice(1)) },
    ...
    { label: 'Process', active: activeProcess, setActive: setActiveProcess, value: processType, setValue: setProcessType, list: ['-- All --'].concat(PROCESS_LIST.slice(1)) },
  ];
        ...
        {!submitted && (
          <form onSubmit={handleSubmit} style={{ backgroundColor: '#ffffff', borderRadius: 8, padding: '20px 24px', boxShadow: '0 1px 3px rgba(0,0,0,0.05)', border: '1px solid #e2e8f0', marginBottom: 24 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '16px 24px', marginBottom: 20, backgroundColor: '#f1f5f9', padding: 16, borderRadius: 8 }}>
              {radioDropdownFields.map(({ label, active, setActive, value, setValue, list }) => (
                <div key={label} style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                  <label style={{ display: 'flex', alignItems: 'center', gap: 6, fontSize: 13, fontWeight: 600, color: '#334155', cursor: 'pointer', minWidth: 130 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 20, marginBottom: 20 }}>
              ...
              <div style={{ padding: 16, backgroundColor: '#f8fafc', border: '1px solid #e2e8f0', borderRadius: 8 }}>
                <label style={{ display: 'block', fontSize: 12, fontWeight: 700, color: '#64748b', marginBottom: 12, textTransform: 'uppercase' }}>Date Range</label>
          ...
          <div>
            ...
            <div style={{ backgroundColor: '#ffffff', borderRadius: 8, boxShadow: '0 1px 3px rgba(0,0,0,0.05)', border: '1px solid #e2e8f0', overflow: 'hidden' }}>
              <div style={{ padding: '16px 20px', backgroundColor: '#f8fafc', borderBottom: '1px solid #e2e8f0', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <div>
                  <h3 style={{ margin: 0, fontSize: 16, fontWeight: 700, color: '#0f172a' }}>Process Pending Status — Results</h3>
              ...
              <div style={{ overflowX: 'auto', width: '100%' }}>
                <table style={{ width: '100%', minWidth: 900, borderCollapse: 'collapse', fontSize: 13 }}>
                  ...
                  <tbody>
                    <tr>
                      <td colSpan={8} style={{ padding: 32, textAlign: 'center', color: '#64748b', fontStyle: 'italic' }}>
                        Process Pending Status data will be displayed here.
                      </td>
                    </tr>
                  </tbody>
                </table>
